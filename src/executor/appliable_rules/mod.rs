...
/// Errors on invalid rules or failed io
#[io_fn]
fn build_rules_with_tokenization_data_and_context<'s, G: ContextIoGetter>(rules: &'s str, mut tokenization_data: TokenizationData<'s>, getter: &mut G, ctx: &mut G::InputContext) -> Result<AppliableRules<'s>, ScaError> {
