...
fn inserted_optional() {
    ...
    choices.optional = Cow::Owned(HashMap::from_iter([(&ScopeId::Name("label"), true)]));
...
fn non_inserted_optional() {
    let mut choices = Choices::default();
    choices.optional = Cow::Owned(HashMap::from_iter([(&ScopeId::Name("label"), false)]));
...
fn first_in_selection() {
    let mut choices = Choices::default();
    choices.selection = Cow::Owned(HashMap::from_iter([(&ScopeId::Name("label"), 0)]));
...
fn second_in_selection() {
    let mut choices = Choices::default();
    choices.selection = Cow::Owned(HashMap::from_iter([(&ScopeId::Name("label"), 1)]));
