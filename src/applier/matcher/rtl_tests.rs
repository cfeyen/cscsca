...
#[test]
fn match_one_phone() {
    assert_eq!(Ok(true), tokens_match_phones_from_right(&[RuleToken::Phone(Phone::new("a"))], &[Phone::new("a")], &mut Choices::default()));
}

#[test]
fn fail_match_one_phone() {
    assert_eq!(Ok(false), tokens_match_phones_from_right(&[RuleToken::Phone(Phone::new("a"))], &[Phone::new("b")], &mut Choices::default()));
}

#[test]
fn fail_match_one_token_to_no_phones() {
    assert_eq!(Ok(false), tokens_match_phones_from_right(&[RuleToken::Phone(Phone::new("a"))], &[], &mut Choices::default()));
}
...
fn match_option_to_phone_and_check_mapping() {
    ...
    _ = tokens_match_phones_from_right(&scope, &[Phone::new("a")], &mut choices);
...
fn fail_match_same_labeled_optional_scopes_where_the_first_could_match_but_the_second_could_not() {
    ...
    assert_eq!(Ok(false), tokens_match_phones_from_right(&tokens, &[Phone::new("a"), Phone::new("b"), Phone::new("d")], &mut choices));
...
fn match_different_labeled_selection() {
    ...
    assert_eq!(Ok(true), tokens_match_phones_from_right(&tokens, &[Phone::new("a"), Phone::new("e")], &mut choices));
