...
#[test]
fn match_none() {
    assert_eq!(Ok(true), tokens_match_phones_from_right(&mut [], &[], &mut Choices::default()));
}

#[test]
fn match_one_phone() {
    assert_eq!(Ok(true), tokens_match_phones_from_right(&mut [&RuleToken::Phone(Phone::new("a"))], &[Phone::new("a")], &mut Choices::default()));
}

#[test]
fn fail_match_one_phone() {
    assert_eq!(Ok(false), tokens_match_phones_from_right(&mut [&RuleToken::Phone(Phone::new("a"))], &[Phone::new("b")], &mut Choices::default()));
}

#[test]
fn fail_match_one_token_to_no_phones() {
    assert_eq!(Ok(false), tokens_match_phones_from_right(&mut [&RuleToken::Phone(Phone::new("a"))], &[], &mut Choices::default()));
}

#[test]
fn match_three_phones() {
    assert_eq!(Ok(true), tokens_match_phones_from_right(&mut [
...
fn fail_match_three_tokens_to_two_phones() {
    assert_eq!(Ok(false), tokens_match_phones_from_right(&mut [
        &RuleToken::Phone(Phone::new("a")),
        &RuleToken::Phone(Phone::new("b")),
        &RuleToken::Phone(Phone::new("c")),
...
fn match_two_tokens_to_three_phones_from_late_start() {
    assert_eq!(Ok(true), tokens_match_phones(&mut [
        &RuleToken::Phone(Phone::new("b")),
        &RuleToken::Phone(Phone::new("c")),
    ], &[Phone::new("a"), Phone::new("b"), Phone::new("c")], 0, &mut 1, &mut Choices::default(), Direction::RTL));
}
...
fn match_option_to_phone_and_check_mapping() {
    ...
    _ = tokens_match_phones_from_right(&mut [
        &scope,
    ], &[Phone::new("a")], &mut choices);
...
fn fail_match_same_labeled_optional_scopes_where_the_first_could_match_but_the_second_could_not() {
    ...
    assert_eq!(Ok(false), tokens_match_phones_from_right(&mut [
        ...
        &phone,
        &scope_2,
    ], &[Phone::new("a"), Phone::new("b"), Phone::new("d")], &mut choices));
...
fn match_shorter_labeled_gap() {
    assert_eq!(Ok(true), tokens_match_phones_from_right(&mut [
        ...
        &RuleToken::Gap { id: Some("label") },
        &RuleToken::Phone(Phone::new("c")),
    ], &[Phone::new("a"), Phone::new("b"), Phone::new("d"), Phone::new("c")], &mut Choices::default()))
}

#[test]
fn match_equal_labeled_gap() {
    assert_eq!(Ok(true), tokens_match_phones_from_left(&mut [
        &RuleToken::Phone(Phone::new("a")),
        &RuleToken::Gap { id: Some("label") },
        &RuleToken::Phone(Phone::new("b")),
        &RuleToken::Gap { id: Some("label") },
...
fn fail_match_longer_labeled_gap() {
    assert_eq!(Ok(false), tokens_match_phones_from_right(&mut [
        ...
        &RuleToken::Gap { id: Some("label") },
        &RuleToken::Phone(Phone::new("c")),
    ], &[Phone::new("a"), Phone::new("d"), Phone::new("d"), Phone::new("b"), Phone::new("d"), Phone::new("c")], &mut Choices::default()))
}
...
fn fail_match_selection() {
    assert_eq!(Ok(false), tokens_match_phones_from_left(&mut [
        &RuleToken::SelectionScope { id: Some(ScopeId::Name("label")), options: vec![
            vec![RuleToken::Phone(Phone::new("a"))],
            vec![RuleToken::Phone(Phone::new("b"))],
            vec![RuleToken::Phone(Phone::new("c"))],
...
fn match_different_labeled_selection() {
    ...
    assert_eq!(Ok(true), tokens_match_phones_from_right(&mut [
        &first_scope,
        &second_scope,
    ], &[Phone::new("a"), Phone::new("e")], &mut choices));
