...
#[test]
fn match_one_phone() {
    assert_eq!(Ok(true), tokens_match_phones_from_left(&[RuleToken::Phone(Phone::Symbol("a"))], &[Phone::Symbol("a")], &mut Choices::default()));
}

#[test]
fn fail_match_one_phone() {
    assert_eq!(Ok(false), tokens_match_phones_from_left(&[RuleToken::Phone(Phone::Symbol("a"))], &[Phone::Symbol("b")], &mut Choices::default()));
}

#[test]
fn fail_match_one_token_to_no_phones() {
    assert_eq!(Ok(false), tokens_match_phones_from_left(&[RuleToken::Phone(Phone::Symbol("a"))], &[], &mut Choices::default()));
}
...
fn match_shorter_labeled_gap() {
    assert_eq!(Ok(true), tokens_match_phones_from_left(&[
        ...
        RuleToken::Gap { id: Some("label") },
        RuleToken::Phone(Phone::Symbol("c")),
    ], &[Phone::Symbol("a"), Phone::Symbol("d"), Phone::Symbol("b"), Phone::Symbol("c")], &mut Choices::default()))
}
...
fn fail_match_longer_labeled_gap() {
    assert_eq!(Ok(false), tokens_match_phones_from_left(&[
        ...
        RuleToken::Gap { id: Some("label") },
        RuleToken::Phone(Phone::Symbol("c")),
    ], &[Phone::Symbol("a"), Phone::Symbol("d"), Phone::Symbol("b"), Phone::Symbol("d"), Phone::Symbol("d"), Phone::Symbol("c")], &mut Choices::default()))
}
