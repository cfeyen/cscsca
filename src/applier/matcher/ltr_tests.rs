...
#[test]
fn match_none() {
    assert_eq!(Ok(true), tokens_match_phones_from_left(&mut [], &[], &mut Choices::default()));
}

#[test]
fn match_one_phone() {
    assert_eq!(Ok(true), tokens_match_phones_from_left(&mut [&RuleToken::Phone(Phone::new("a"))], &[Phone::new("a")], &mut Choices::default()));
}

#[test]
fn fail_match_one_phone() {
    assert_eq!(Ok(false), tokens_match_phones_from_left(&mut [&RuleToken::Phone(Phone::new("a"))], &[Phone::new("b")], &mut Choices::default()));
}

#[test]
fn fail_match_one_token_to_no_phones() {
    assert_eq!(Ok(false), tokens_match_phones_from_left(&mut [&RuleToken::Phone(Phone::new("a"))], &[], &mut Choices::default()));
}
...
fn match_option_to_phone_and_check_mapping() {
    ...
    _ = tokens_match_phones_from_left(&mut [
        &scope,
